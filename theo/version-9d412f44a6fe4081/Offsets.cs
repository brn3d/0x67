...
namespace Offsets {
    ...
    public static class FakeDataModel {
         public const long Pointer = 0x7a8f908;
    ...
    public static class MouseService {
         ...
         public const long SensitivityPointer = 0x7b2ee10;
    }
    ...
    public static class PlayerConfigurer {
         public const long Pointer = 0x7a650d0;
    }
    ...
    public static class RunService {
         ...
         public const long HeartbeatTask = 0x148;
    }
    ...
    public static class TaskScheduler {
         ...
         public const long Pointer = 0x7b68f00;
    }
    ...
    public static class VisualEngine {
         ...
         public const long Pointer = 0x763d3d0;
