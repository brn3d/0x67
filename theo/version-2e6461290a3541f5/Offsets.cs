...
namespace Offsets {
    ...
    public static class FakeDataModel {
         public const long Pointer = 0x7b990f8;
    ...
    public static class MouseService {
         ...
         public const long SensitivityPointer = 0x7c387f0;
    }
    ...
    public static class Player {
         ...
         public const long Mouse = 0x1158;
    ...
    public static class PlayerConfigurer {
         public const long Pointer = 0x7b6e5a8;
    }
    ...
    public static class RunService {
         public const long HeartbeatFPS = 0xc4;
         public const long HeartbeatTask = 0x1b8;
    }
    ...
    public static class TaskScheduler {
         ...
         public const long Pointer = 0x7c73d70;
    }
    ...
    public static class VisualEngine {
         ...
         public const long Pointer = 0x7746018;
